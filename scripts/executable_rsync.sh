...
if [[ "$1" == "comp" ]]; then
rsync -avhu --progress --no-perms --delete --exclude='~Music/test/' $source_dir $destination_dir
  ...
  rsync -avhu --progress --delete --no-perms --exclude='~Music/test/' $HOME/kdefilesd/Music/ $HOME/Music/
else
